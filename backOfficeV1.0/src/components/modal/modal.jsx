 ...
 * @param {object[]} props.modalValues the data that need to be display in the modal selects, cascaders or images
...
function ModalView({
    ...
    const getModalTitle = () => {
        if (modalTitle) {
            const title = modalTitle.replace(/([A-Z])/g, " $1").toLowerCase();
