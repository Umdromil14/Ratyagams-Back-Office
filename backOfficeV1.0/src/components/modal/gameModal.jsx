 ...
 * @param {object[]} modalValues.users the users used in the modal select
 * @param {object[]} modalValues.publications the publications used in the modal cascader
...
function gameModal(gameForm, modalValues, handleSearch, initialValues) {
        ...
        if (Object.keys(initialValues).length !== 0) {
            return {
                ...
                review_date: initialValues.review_date
                    ? dayjs(initialValues.review_date, "DD/MM/YYYY")
                    : null,
    ...
    /**
     * Gets the default value of the cascader
     * 
     * @returns {string[]} the default value of the cascader
     */
