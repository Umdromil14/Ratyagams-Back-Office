...
function modalModeling(title, data, form) {
    switch (title) {
        case Enum.titlePublication:
            return publicationModal(form, data);
        case Enum.titleGame:
            return gameModal(form, data);
        case Enum.titlePlatform:
            return platformModal(form);
        case Enum.titleUser:
            return userModal(form);
        case Enum.titleCategory:
            return categoryModal(form, data);
            ...
            {MultipleScrollDown(
                ...
                (value) => {
                    if (value) {
                        ...
                        gameInformations.publication_id = undefined;
                    }
                }
            )}
            {RadioButton(
